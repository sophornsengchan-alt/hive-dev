...
import getRecords from '@salesforce/apex/CustomDataTableForAMController.getRecords';
const FILTER_BY_TODAY = '{date}=TODAY';
const FILTER_BY_NEXT7Day = '({date}=TODAY OR {date}=NEXT_N_DAYS:7)';
const LINK_SUFIX = 'LINK';
export default class CustomDataTableForAM extends LightningElement {
    errorMessage;
    allColumns = [];
    ...
    @wire(getRecords, {
        ...
        recordOwnerField: '$recordOwnerField',
