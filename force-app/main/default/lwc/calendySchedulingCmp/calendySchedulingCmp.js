/*********************************************************************************************************************************
@ Component:    calendySchedulingCmp
@ Version:      1.0
@ Author:       Anujit Das
----------------------------------------------------------------------------------------------------------------------------------
@ Change history: 30.11.2023 / Acmatac Seing / US-0014324 - Ph 1 - 4 Register and Book first call
*********************************************************************************************************************************/
...
export default class CalendySchedulingCmp extends LightningElement {
  isLoading = true
  _url
  _containerStyles
  ...
  onCalendlyEvent(e) {
    ...
    //   console.log('eventName::', eventName);
      if (eventName === CalendlyEvent.EVENT_SCHEDULED) {
        ...
        /*console.log('event::'+ JSON.stringify(event)+'::invitee:::'+JSON.stringify(invitee));*/
        ...
        this.dispatchEvent(new CustomEvent("calendlyeventscheduled", { detail: calendlyEvent }));
      }
    }
  }
  ...
  handleCalendlyModalClose(){
    this.dispatchEvent(new CustomEvent("calendlymodalclose", { detail: false }));
